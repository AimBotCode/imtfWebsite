<template>
  <div>
    <Navbar />
    <Subbar title="Seasonality" :submenu="true" />
    ...
    <div class="page-wrapper">
      ...
      <div class="page-content-tab">
        ...
        <!-- <div class="tradingview-widget-copyright">
          <a href="https://www.tradingview.com/symbols/NASDAQ-AAPL/" rel="noopener" target="_blank"><span class="blue-text">Price Today</span></a> by TradingView
        </div> -->
        <!--Start Footer-->
        <Footer />
      <!--end footer-->
...
export default {
  ...
  mounted () {
    ...
    const routeParams = this.$router.history.current.query
    if (routeParams.sym) {
      this.chooseSymbol(routeParams.sym)
    }
  },
  methods: {
    getSymbols () {
