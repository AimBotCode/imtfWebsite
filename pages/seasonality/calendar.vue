<template>
  <div>
    <Navbar />
    <Subbar title="Seasonality > Calendar" :submenu="true" />
            ...
            <div class="col-lg-9">
              ...
              <div v-else class="card">
                ...
                <div class="card-header bg-light">
                  <div class="row align-items-center">
                    <div class="col">
                      <FormsCalendar v-if="show.filters" @change="formChanged" />
                    </div>
                  </div>
                </div>
  ...
  methods: {
    getData () {
      this.$xhr.api.post('/api/seasonality', this.formData).then((response) => {
        this.$store.commit('app/setCalendarForm', JSON.parse(JSON.stringify(this.formData)))
