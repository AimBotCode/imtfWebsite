                    ...
                    <div class="card-body">
                      <div class="row d-flex justify-content-center mb-2">
                        ...
                        <div class="col-auto align-self-center">
                          <img src="assets/images/ipo/money.png" class="thumb-lg" alt="...">
                        </div><!--end col-->
                      </div><!--end row-->
                        ...
                        <div class="carousel-inner">
                          <div class="carousel-item ">
                            <div class="text-center">
                              <img src="assets/images/ipo/ipo-3.png" class="thumb-lg" alt="...">
                              <h3 class="my-1 font-20 fw-bold">
                                Life's Good
                              </h3>
                              <p class="mb-0 fw-semibold">
                                Sep 14, 2021 to Sep 18, 2021
                              </p>
                              <p class="mb-2">
                                Allotment : <span class="text-muted">Sep 22, 2021</span>
                              </p>
                          ...
                          <div class="carousel-item active">
                            <div class="text-center">
                              <img src="assets/images/ipo/ipo-1.png" class="thumb-lg" alt="...">
                              <h3 class="my-1 font-20 fw-bold">
                                Starbucks
                              </h3>
                              <p class="mb-0 fw-semibold">
                                Sep 02, 2021 to Sep 05, 2021
                              </p>
                              <p class="mb-2">
                                Allotment : <span class="text-muted">Sep 08, 2021</span>
                              </p>
                              <a href="#" class="btn btn-sm btn-de-primary">Apply</a>
                            </div>
                          </div><!--end carousel-item-->
                          <div class="carousel-item">
                            <div class="text-center">
                              <img src="assets/images/ipo/ipo-2.png" class="thumb-lg" alt="...">
                              <h3 class="my-1 font-20 fw-bold">
                                McDonald's
                              </h3>
                              <p class="mb-0 fw-semibold">
                              ...
                              <p class="mb-2">
                                Allotment : <span class="text-muted">Sep 14, 2021</span>
                              </p>
                              <a href="#" class="btn btn-sm btn-de-primary">Apply</a>
                            </div>
                          </div><!--end carousel-item-->
                        ...
                        <div class="col">
                          <div class="nifty-50 d-inline-block me-3">
                            ...
                            <div class="d-inline-block font-15 fw-bold">
                              16,538.45 <span class="text-danger font-11 fw-semibold">-78.00</span> <span class="text-danger font-11 fw-semibold">(0.49%)</span>
                            </div>
                          </div>
                        </div><!--end col-->
                        <div class="col-auto">
